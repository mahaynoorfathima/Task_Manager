...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="manager_reply1.css">
</head>
<header>
 ...
 <a href="home.html">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar" >
   ...
   <li class="nav-item">
        <a class="nav-link" href="client_portal.php">LOGOUT</a>
      </li>
...
<center>
  ...
  <legend align="center" ><i>REPLY TO CLIENT</i></legend><br>
  <label>NAME</label>
  <input type="text" name="name"  pattern="\w+[a-z]"
        required="">
        <label>TO</label>
  <input type="text" name="too"  pattern="\w+[a-z]"
        required=""><br><br>
  <label >EMAIL</label>
   <input type="email"  name="email" class="mesg" required="" /><br><br>
      <label >MESSAGE</label>
...
$insertquery="INSERT INTO messa(manager, too, email, message) VALUES ('$name','$too','$email','$message')";
