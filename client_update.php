...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="client_update.css">
  <style type="text/css">
    button
    {
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar" >
    <ul class="navbar-nav">
      <li class="nav-item"style="margin-left: 620px;">
        <a class="nav-link" href="client_portal.php">Order</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="dashboard.php">Task Assign</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">Updated Detials</a>
      </li>
   <li class="nav-item">
...
<th>REPLY TO CLIENT</th>
  ...
  {
    echo "<tr><td>".$row['name']."</td><td>".$row['email']."</td><td>".$row['info']."</td><td>".$row['message']."</td><td><a href=manager_reply.php><button>reply</button></td></a></tr>";
  }
  echo "</table>";
